...
model_path = 'height-weight-classification-model.pkl'
...
weight_map = ['medium', 'light', 'heavy']  # Replace with the actual categories from training
...
for filename in os.listdir(preprocessed_dir):
    if filename.endswith('.csv'):
        ...
        # Compute features
        features = compute_features(data, data_for_angle)
        ...
        new_filename = f"{predicted_weight}_{predicted_height}.csv"
