...
# The acquired data should be put in the ./Predict folder. The folder ./Preprocessed folder will contain the renamed files
# a file will get the predicted labels for height and weight in the name. ex.: light_floor_{nameOfOriginalFile}.csv
...
model_path = 'height-weight-classification-modelB.pkl'
