...
# of an object picked up. You can use the trained model by running height-weight-predictor-modelA.py
...
def compute_features(data, data_for_angle, data_for_force):
    ...
    # Also store additional data calculations for training
...
output_file = 'testset-results-modelA.xlsx'
wb.save(output_file)

# Save the model to pickle file
joblib.dump(multi_output_model, 'height-weight-classification-modelA.pkl')
print("Multi-output model saved as 'height-weight-classification-modelA.pkl'")
